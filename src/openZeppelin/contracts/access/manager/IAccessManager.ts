...
/**
 * [OpenZeppelin-IAccessManager](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/access/manager/IAccessManager.sol)
 */
export const iAccessManagerAbi = narrow([
  {
    inputs: [
      {
