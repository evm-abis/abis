...
/**
 * [OpenZeppelin-TimelockController](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/governance/TimelockController.sol)
 */
export const timelockControllerAbi = narrow([
  {
    inputs: [
      {
